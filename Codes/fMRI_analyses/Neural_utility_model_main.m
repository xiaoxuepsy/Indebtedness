%%==========================================================================
% This is the main part of codes for neural utility model in Gao et al., 2021, The hidden cost of receiving favors: A theory of indebtedness
% This script should be used in combination with the function file:
% Neural_utility_model.m
...
% Load data
basedir = './';
dat = importdata(fullfile(basedir, 'Brain_predictions_for_E2_and_PCare.txt'));
data = dat.data;
...
lin = comp_model(data,dat.textdata,'Neural_utility_model','nStart',1000, 'param_min',[0, 0], 'param_max', [1,1], 'esttype','SSE');
